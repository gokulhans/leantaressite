...
function Feature() {
    return (
        ...
        <h1 class="font-bold text-4xl"><span class="text-red-500">WHAT 
    ...
    <div className="py-4">
        <div className="container m-auto px-6 text-gray-500 md:px-12 xl:px-0">
            <div className="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
                <div
                    className=" border border-gray-100 dark:border-gray-700 rounded-xl shadow-md bg-white dark:bg-gray-800 px-8 pt-12 shadow-2xl shadow-gray-600/10 dark:shadow-none sm:px-12 lg:px-8">
